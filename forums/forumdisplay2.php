...
/**
*** CUSTOM!!!
*** This is custom!  Get the immediate parent forum and its name.
**/
$navbitlen = count($navbits);

if( $navbitlen > 5 ){
	$parentforumname = $navbits[$navbitlen-2]['name'];
}
else{
	$parentforumname = $navbits[$navbitlen-1]['name'];
}
